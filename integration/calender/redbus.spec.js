...
// describe('valiidate redbus calender date', () => 
// {
//     it('validate the future date', () =>
//     {
//         cypress.visit('https://www.redbus.com/')
//         let kk = new Date()
//         kk.setDate(kk.getDate() + 370)

//         let year = kk.getFullYear()
//         let month = kk.toLocaleString('defult', { month: 'short' })
...
//         function fDate()
//             {
//                 cy.get('.rb-monthTable.first.last').last()
//                     .children().first().find('td').each((el) => {
//                         //cy.log(el.text())
